    ...
    >
      ...
      >
        <div className="flex h-[50px] items-center gap-1 justify-start ">
          <div
            className="flex items-center justify-center rounded-lg aspect-square size-6 bg-sidebar-primary text-sidebar-primary-foreground"
          >
            <Command className="size-4" />
          </div>
          {state !== "collapsed" && (
            <div className="grid flex-1 ml-px text-2xl leading-tight text-left">
              <h2 className="font-medium truncate">Meetly</h2>
            </div>
          )}
