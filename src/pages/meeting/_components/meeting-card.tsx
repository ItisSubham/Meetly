...
const MeetingCard = (props: {
  ...
  return (
    <div className="w-full">
      ...
      border-[#E5EFFE] bg-[#fafafa] text-base font-bold tracking-wide"
      >
        {formattedDate}
      </h2>
      ...
      <div role="buton" className="event-list-body" onClick={toggleDetails}>
        <div
          className="relative flex flex-row w-full p-6 text-left transition-colors duration-200 ease-in-out bg-white cursor-pointer"
        >
          <div
      ...
      <div
        ref={detailsRef}
        className="overflow-hidden transition-all duration-300 ease-in-out event-details"
        style={{
          maxHeight: isShow ? `${detailsRef.current?.scrollHeight}px` : "0px",
          padding: isShow ? "8px 24px 24px 24px" : "0 24px",
        }}
      >
        <div className="flex flex-col-reverse pb-5 md:flex-row">
